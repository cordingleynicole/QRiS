...
This playlist includes some best practices mentioned earlier in the workshop, including digitizing, georeferencing, and a discussion on resolution and building pyramids. 
...
The full, completed project example data used in this workshop can be downloaded [**here**](https://drive.google.com/file/d/1yLqHLtyCSd_YOy9K3EB1Hqc544B-m-18/view?usp=sharing).

Data used in the tutorial can be found [**here**](https://drive.google.com/file/d/1R55j8M6vHoXkcxQsjtrNcf25RtdjpEmA/view?usp=drive_link). With this data, you can start from scratch with an empty project and work through the steps of importing existing data, like surfaces, into your project, following the tutorial.

Both projects use Wall Creek, Oregon. See the project area [**here**](https://data.riverscapes.net/p/2f0ae06d-e671-4d8d-afb7-9d7b62eeb107/). 
