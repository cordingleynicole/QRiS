...
Produce or obtain imagery. Consider the file size and imagery resolution needs. A project at maximum resolution may not be necessary and will likely cause performance problems. In the tutorial, we used the example of a project with a maximum resolution of 1.7 cm down-sampled to 5 cm, which cut the file size in half and improved performance. 
To down-sample a project, in the processing toolbox > search warp > use the Warp (reproject) tool
